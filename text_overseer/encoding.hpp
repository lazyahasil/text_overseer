...
namespace text_overseer
{
	inline namespace encoding
	{
		...
		inline namespace convert
		{
			...
			struct WstringConverter : public std::wstring_convert<LocalFacet>
			{
				WstringConverter() : std::wstring_convert<LocalFacet>(new LocalFacet("")) { }
				~WstringConverter() = default;
			};
			...
			{
				static WstringConverter converter;
